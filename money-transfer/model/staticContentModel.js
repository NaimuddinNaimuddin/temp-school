...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        let obj = {
        ...
        mongoose.model('staticContent', staticContent).create(obj, (error, success) => {
            if (error)
...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        ...
        mongoose.model('staticContent', staticContent).create(obj1, (error, success) => {
            if (error)
                console.log("Error is" + error)
            else
...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        ...
        mongoose.model('staticContent', staticContent).create(obj3, (error, success) => {
            if (error)
                console.log("Error is" + error)
            else
...
mongoose.model('staticContent', staticContent).find((error, result) => {
    if (result.length == 0) {
        ...
        mongoose.model('staticContent', staticContent).create(obj4, (error, success) => {
            if (error)
                console.log("Error is" + error)
            else
                console.log("Static privacy content saved succesfully.", success);
